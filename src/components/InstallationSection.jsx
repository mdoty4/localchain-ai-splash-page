...
export function InstallationSection() {
  ...
  const commands = [
    { comment: '# Clone the repository', cmd: 'git clone https://github.com/mdoty4/sequencer.git' },
    { comment: '# Enter the project directory', cmd: 'cd sequencer' },
              ...
              <pre className="p-6 font-mono text-code-xs overflow-x-auto" aria-label="Installation commands">
                ...
                >
                  ...
                  <div className="mt-2 text-teal">
                    ▸ Sequencer ready. Open your browser to get started.
                  </div>
                </motion.div>
              </pre>
            </motion.div>
